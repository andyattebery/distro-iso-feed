...
produced the key* (`propose_common._confirms`). Anything that does not resolve is
dropped and reported under "could not synthesize", so a merged PR is mergeable as-is.
"""
